...
// const LeaveBalance = () => {
//   const progressData = [
//     { value: 2, subject: 'Casual Leave' },
//     { value: 3, subject: 'Earned Leave' },
//     { value: 4, subject: 'Medical Leave' },
//     { value: 1, subject: 'Festival Leave' },
//   ];
...
//         <Paper key={index} sx={{ p: 7, borderRadius:'10px' }}>
...
// const LeaveBalProgress = ({ value, subject }) => {
//   const maxValue = 5; // Define 5 as 100%
//   const normalizedValue = Math.min(Math.max(value, 0), maxValue) / maxValue * 100;
//   const strokeColor = normalizedValue >= 0 ? '#2196f3' : '#aaaaaa';
