  ...
  const playstoreButtonStyles=isMobile?null: { position: 'fixed',
  ...
  zIndex: theme.zIndex.tooltip,
    ...
    return (
      <ThemeProvider theme={defaultTheme}>
        <Grid container height={ isMobile?'100%':'100vh'} width='100%' display='flex' flexDirection={isMobile?'column':'row'}  justifyContent='center' minHeight='100vh' 
        backgroundColor={(t) => (t.palette.mode === 'light' ? t.palette.grey[50] : t.palette.grey[900])} >
          <CssBaseline />
          {/* Left Side Logo ==================================================================  */}
          <Grid item xs={12} sm={6} md={6} paddingBottom='3rem' backgroundColor='' >
          <LeftLogo />
          </Grid>
         ...
         {isMobile?<Grid item  flex='auto' alignContent='flex-end' >
              <Box pt={1}>
                <PoweredBySection />
                <Box pt={1}></Box>
                ...
                <Box></Box>                
                 ...
                 {!isMobile?
                  <Box ><PoweredBySection/></Box>:null}
                    ...
                    {!isMobile?<Box sx={playstoreButtonStyles} >
                    <AppStoreButtonsGroup/>
                    </Box>:null}
            </Box>
