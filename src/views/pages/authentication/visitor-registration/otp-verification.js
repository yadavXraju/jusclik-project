...
export const OtpVerification = ({ step, handleSteps, mobileNumber }) => {
  ...
  return (
    <Box sx={{ ...css.center }}>
      <Paper sx={{ ...css.mobilePaper, minWidth: '20rem' }} elevation={2}>
        <Typography variant="h6" pb={1} sx={{ ...css.formTextColor, sm: '14px', ...css.horizontalCenter }}>
          Verification
        </Typography>
        <Typography pb={1} fontWeight="400" textAlign="center" sx={{ ...css.formTextColor, ...css.horizontalCenter }}>
