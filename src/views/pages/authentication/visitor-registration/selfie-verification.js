...
export const SelfieVerification = ({ step, handleSteps, md, capturedImage, setCapturedImage }) => {
        ...
        <Paper sx={{ ...css.mobilePaper, minWidth: md ? '20rem' : '25rem', maxWidth: '60%' }} elevation={2}>
          <Box display="flex" flexDirection="column">
            <Box sx={{ ...css.horizontalCenter }}>
              <Typography variant="h6" sx={{ ...css.formTextColor, fontWeight: '400', sm: '14px' }}>
                Take a Selfie
              </Typography>
            </Box>
            <Divider />
                ...
                {stream && showCamera && (
                  <Box sx={{ ...css.horizontalCenter, flexDirection: 'column', mt: '1rem', width: '100%' }}>
                    ...
                    {showTakePhotoButton && (
                      <Box>
                        <Button
                          sx={{ ...css.center, ...css.marginAuto, ...css.submitButton, ...css.button }}
                          onClick={takePhoto}
                          disableElevation
                        >
                          Take Photo
