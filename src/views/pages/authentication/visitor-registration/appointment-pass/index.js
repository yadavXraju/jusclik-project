  ...
  return (
    <Box sx={{ display: 'flex', alignItems: 'center', justifyContent: 'center', marginTop: '80px', marginBottom: '50px' }}>
      <Box sx={{ border: '1px solid lightgrey', marginTop: '-50px' }}>
        ...
        <Box width={390} my={2} display="flex" justifyContent="center" gap={2} p={2} sx={{ marginTop: '0px' }} ref={downloadRef}>
          <Box
            ...
            <Typography variant="h5" color="white" marginTop={3}>
              {passDetails.date} <FiberManualRecordIcon style={{ verticalAlign: 'middle', lineHeight: 0, fontSize: 'small' }} /> {passDetails.time}{' '}
              <FiberManualRecordIcon style={{ verticalAlign: 'middle', lineHeight: 0, fontSize: 'small' }} /> ID: abcd123{' '}
            </Typography>
        ...
        <ListItemText sx={{'& .MuiTypography-root':{color:'white'}}} primary="1. Get vaccinated as soon as it’s your turn and follow local guidance on vaccination." />
        <ListItemText sx={{'& .MuiTypography-root':{color:'white'}}} primary="2. Keep physical distance of at least 1 metre from others, even if they don’t appear to be sick. Avoid crowds and close contact." />
        <ListItemText sx={{'& .MuiTypography-root':{color:'white'}}} primary="3. Wear a properly fitted mask when physical distancing is not possible and in poorly ventilated settings." />
        <ListItemText sx={{'& .MuiTypography-root':{color:'white'}}} primary="4. Clean your hands frequently with alcohol-based hand rub or soap and water." />
        <ListItemText sx={{'& .MuiTypography-root':{color:'white'}}} primary="5. Cover your mouth and nose with a bent elbow or tissue when you cough or sneeze. Dispose of used tissues immediately and clean hands regularly." />
        <ListItemText sx={{'& .MuiTypography-root':{color:'white'}}} primary="6. If you develop symptoms or test positive for COVID-19, self-isolate until you recover." />
    </List>
            </Typography>
          </Box>
        </Box>
