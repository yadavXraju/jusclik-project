 ...
 const labelStyles = {
  ...
  return (
    <>
      ...
      <InputLabel sx={{...labelStyles , marginTop:'0px'}} htmlFor="student-name">Student&apos;s Name</InputLabel>
      <TextField
        id="student-name"
        variant="outlined"
        fullWidth
...
<InputLabel sx={{...labelStyles}} htmlFor="student-name">Gender</InputLabel>
              <Dropdown
...
<InputLabel sx={{...labelStyles}} htmlFor="id_number">{allStudentDetails.child_photo_id === 'passport' ? 'Enter Passport Number' : 'Enter Aadhar Card Number'}</InputLabel>
...
<InputLabel sx={{...labelStyles}} htmlFor="email_address">Email Address (you can add up to 2 numbers separated by commas)</InputLabel>
...
<InputLabel sx={{...labelStyles}} htmlFor="city">City</InputLabel>
...
<InputLabel sx={{...labelStyles}} htmlFor="enrolled_since">Enrolled Since</InputLabel>
              <Dropdown
            ...
            <Grid item xs={4}>
              ...
              <InputLabel sx={{...labelStyles , marginTop:'0px'}} htmlFor="Date_of_Birth">Date of Birth (dd-mm-yyyy)</InputLabel>
              <TextField
                id="outlined-basic"
...
<InputLabel sx={{...labelStyles }} htmlFor="primary_contact">Primary Contact Person</InputLabel>
              <Dropdown
...
<InputLabel sx={{...labelStyles }} htmlFor="preferred_mobile">Preferred Mobile (you can add up to 2 numbers separated by commas)</InputLabel>
              <TextField
                id="outlined-basic"
...
<InputLabel sx={{...labelStyles }} htmlFor="house_no">Flat No / House No</InputLabel>
              <TextField
...
<InputLabel sx={{...labelStyles }} htmlFor="pincode">Pincode</InputLabel>
              <TextField
                id="outlined-basic"
...
<InputLabel sx={{...labelStyles }} htmlFor="board">Board</InputLabel>
              <Dropdown
                label="Board"
                required
                error={errors.board}
            ...
            <InputLabel sx={{...labelStyles, marginTop:'0px' }} htmlFor="nationality">Nationality</InputLabel>
              <TextField
                id="outlined-basic"
...
<InputLabel sx={{...labelStyles }} htmlFor="child_photo_id">Child Photo ID (Either Aadhar or Passport No.)</InputLabel>
              <Dropdown
            ...
            <InputLabel sx={{...labelStyles }} htmlFor="blood_group">Blood Group</InputLabel>
