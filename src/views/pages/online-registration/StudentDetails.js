...
//             <InputLabel sx={{ ...labelStyles, ...(Res2560?null:{marginTop:'40px'}) }} htmlFor="id_number">
//               {allStudentDetails.child_photo_id === 'passport' ? 'Enter Passport Number' : 'Enter Aadhar Card Number'}
//             </InputLabel>
...
//             <InputLabel sx={{ ...labelStyles, ...(Res2560?null:{marginTop:'40px'}) }} htmlFor="house_no">
//               Flat No / House No
//             </InputLabel>
//             <TextField
//               name="house_no"
...
//             <InputLabel sx={{ ...labelStyles, ...(Res2560?null:{marginTop:'40px'}) }} htmlFor="blood_group">
//               Blood Group
//             </InputLabel>
...
//             <InputLabel sx={{ ...labelStyles, ...(Res2560?null:{marginTop:'40px'}) }} htmlFor="current_address">
//               Current Address
//             </InputLabel>
//             <TextField
//               id="outlined-basic"
