...
import { Box, Grid, useMediaQuery, Button, InputAdornment, MenuItem, FormControl, InputLabel, Select } from '@mui/material';
  ...
  return (
    <Box>
      <Grid
        component="form"
        sx={{
          '& > :not(style)': {m:1, width: isMobile ? '100%' : '55ch', paddingLeft: '2px', paddingRight:'5px' }
        }}
        noValidate
        autoComplete="off"
      >
      ...
      <Grid sx={{ paddingTop: '5px',  width: isMobile ? '100%' : '55ch', paddingLeft: '7px' }}>
        <PostDate />
      </Grid>
