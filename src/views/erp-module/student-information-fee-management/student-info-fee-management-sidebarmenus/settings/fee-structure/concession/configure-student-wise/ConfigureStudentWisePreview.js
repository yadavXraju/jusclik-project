...
const ConfigureStudentWisePreview = ({customStyle , clearStates }) => {
    ...
    const studentWiseClass = useSelector((state) => state.configGloballyFormSlice.studentWiseClass);
    ...
    const handleSave = (PreviewData )=>{
        dispatch(configStudentWise(PreviewData))
