              ...
              <Box style={{ border: '1px solid grey' }}>
                ...
                <Grid container>
                  ...
                  <Grid item lg={8} xs={5} style={{ textAlign: 'right' }}>
                    ...
                    <Typography variant="h5" style={{ marginTop: '20px', fontWeight: 'bold', marginRight: '30px', marginBottom: '20px' }}>
                  ...
                  <Grid item lg={6} xs={12}>
                    <Grid container>
                      ...
                      <Grid item lg={8} xs={6}>
                        ...
                        <Typography variant="h5" style={{ marginTop: '20px' }}>
                          1234 Main Street, Suite 101, Cityville, State, Country, 12345-6789
                        </Typography>
                      </Grid>
                    </Grid>
                  </Grid>
