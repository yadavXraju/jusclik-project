           ...
           <Box
              ...
              <Box p={2} sx={{ borderBottom: '2px solid gray' }}>
                <Box>
                  <Box>
                    <Box sx={{ display: "flex" }}>
                      <Typography p={1} variant='h4' sx={{ fontWeight: 'bold', width: '346px' }}>Fees Heads</Typography>
                  ...
                  <Box sx={{ display: "flex" }}>
                    <Typography p={1} variant='h4' sx={{ fontWeight: 'bold', width: '372px' }}>Net Amount Payable:</Typography>
            ...
            <Box
              ...
              <Box sx={{ borderBottom: '2px solid ', display: 'flex', justifyContent: 'center' }}>
                ...
                <Box p={1}>
                  ...
                  <Typography p={1} variant='h4' sx={{ fontWeight: '800', fontSize: '22px' }}> Fee Slip (School Copy)  </Typography>
              ...
              sx={{ border: '2px solid grey' }}>
               <Box sx={{ borderBottom: '2px solid ', display: 'flex', justifyContent: 'center' }}>
                ...
                <Box p={1}>
                  ...
                  <Typography p={1} variant='h4' sx={{ fontWeight: '800', fontSize: '22px' }}> Fee Slip (Parent Copy)  </Typography>
