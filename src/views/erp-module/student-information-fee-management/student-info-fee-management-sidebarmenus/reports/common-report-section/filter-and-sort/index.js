...
const SearchBar = () => {
  ...
  return (
    <Grid container spacing={4} sx={{marginTop:"10px",marginLeft: "-24px", height: 'calc(100vh - 350px)' }}>
      {/*Filter Section*/}
      <Grid xs={12} sm={12} md={6} sx={{ border: "1px solid #e5ebef", backgroundColor: "#eef2f629" }}>
        ...
        <Box sx={{position:"relative",border: "1px solid #f0f5f8", width: "100%" }} ref={ref}>
          ...
          <Box sx={{ display: "flex", flexDirection: "column", position: "absolute", top: "100px", width: "100%", overflowY: "auto", backgroundColor: "#eef2f629", zIndex: "1" }} className="scrollbar">
            {
          ...
          {isOpen && <Box sx={{ width: "calc(100% - 20px)", height: "calc(100vh - 400px)", overflowY: 'auto', zIndex: "2", backgroundColor: "white", paddingLeft: "20px" }} className="scrollbar">
