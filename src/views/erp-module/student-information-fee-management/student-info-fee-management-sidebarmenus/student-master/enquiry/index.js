            ...
            <Grid item xs={12}>
              <Paper>
                <Grid container spacing={3} sx={{ padding: '25px', display: 'flex', alignItems: 'center' }}>
                  <Grid item xs={1}>
                    <Box>
                      <Avatar alt="Remy Sharp" src={AvatarImage} sx={{ width: 76, height: 76 }} />
                    </Box>
                  </Grid>
                  <Grid item xs={5}>
            ...
            <Grid item xs={12} sx={{ marginTop: '40px' }}>
              <Paper>
                <Grid container sx={{ padding: '25px' }} spacing={3}>
                  ...
                  <Grid item xs={4}>
                    <FormControl fullWidth>
                      <InputLabel id="demo-simple-select-label">Bloog Group</InputLabel>
                      <Select
                        labelId="demo-simple-select-label"
                        id="demo-simple-select"
                        value={section}
                  ...
                  <Grid item xs={2}>
                    <TextField id="outlined-basic" label="Age" variant="outlined" value="12Y3M5D" fullWidth />
                  </Grid>
                  <Grid item xs={6}>
