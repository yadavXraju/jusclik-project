  ...
  return (
    <>
      <Grid
        container
        alignItems={'start'}
        sx={{ border: '1px solid rgba(224, 224, 224, 1)', borderRadius: '12px', padding: '2rem', alignItems: 'center' }}
      >
        <Grid
          lg={2}
          sx={{
        ...
        >
          ...
          <Grid>
            ...
            <Box sx={{ textAlign: 'center', mb: 1 }}>
              <Typography variant="h5" sx={{ color: '#8b8989' }}>
                {' '}
                Student Name{' '}
              </Typography>
        ...
        <Grid lg={10} sx={{ paddingLeft: '2rem' }}>
          ...
          <Grid container sx={{ columnGap: '80px', rowGap: '20px', paddingTop: '2rem' }}>
            ...
            <Box>
              ...
              <Typography variant="h5" sx={{ color: '#2196f3', cursor: 'pointer' }}>
                {' '}
                Arnav Rawat (V-A){' '}
              </Typography>
              {/* </Button> */}
