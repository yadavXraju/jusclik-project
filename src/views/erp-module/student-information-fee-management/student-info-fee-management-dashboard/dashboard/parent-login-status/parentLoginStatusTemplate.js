        ...
        <>
            <Paper sx={{
                ...
                <Grid sx={{ display: 'flex', flexDirection: isMediumDesktop ? 'column' : 'row', }}>
                    <Grid lg={6} sx={{ borderRight: '1px solid rgb(227, 227, 227)', flex: isMediumDesktop ? '0 0 100%' : 'auto', maxWidth: isMediumDesktop ? '100% !important' : 'auto', }}>
                    ...
                    <Grid lg={6} sx={{ display: 'flex', justifyContent: 'center', flexDirection: isMediumDesktop ? 'row' : 'column', paddingLeft: isMediumDesktop ? '0' : '40px', gap: isMobile ? '10px' : '20px', flex: isMediumDesktop ? '0 0 100%' : 'auto', maxWidth: isMediumDesktop ? '100% !important' : 'auto', paddingBottom: isMediumDesktop ? '16px' : '0',  padding:isMobile ? '16px' : null}}>
