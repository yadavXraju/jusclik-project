    ...
    return (
        <Paper sx={{
            ...
            <Box sx={{ padding: '24px 24px 0 24px', background: '#f9f9fb', borderRadius: '12px 12px 0 0' , borderBottom:'1px solid rgb(227, 227, 227)' }}>
                <Typography variant='h2' style={{...HeadingCss , border:'none' }} >Stock Status</Typography>
            </Box>
                ...
                {EnrollmentData.map((item, index) => (
                    <Grid key={index} item xs={4}>
                        <Box sx={{
                            ...
                            borderRight:  '1px solid rgb(227, 227, 227)' // Add border to even index items
                        }}>

                            {/* icon */}
                            <Box sx={{ padding: '10px', borderRadius: '12px' }}>
                                {item.icon}
                            </Box>
                            ...
                            <Box>
                              <Typography variant='h3' sx={{ fontSize: '24px', }}>{item.counterNumber}</Typography>
                               <Typography variant='h3' sx={{ fontSize: '16px', fontWeight: '400', paddingTop: '20px' }}>{item.counterTitle}</Typography>
                            </Box>
                        </Box>
                    </Grid>
                ))}
